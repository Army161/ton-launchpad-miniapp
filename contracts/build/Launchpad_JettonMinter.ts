...
async function JettonMinter_init(owner: Address, content: Cell, curveAddress: Address) {
    const __code = Cell.fromHex('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initJettonMinter_init_args({ $$type: 'JettonMinter_init_args', owner, content, curveAddress })(builder);
...
export class JettonMinter implements Contract {
    ...
    static async init(owner: Address, content: Cell, curveAddress: Address) {
        return await JettonMinter_init(owner, content, curveAddress);
    }
    
    static async fromInit(owner: Address, content: Cell, curveAddress: Address) {
        const __gen_init = await JettonMinter_init(owner, content, curveAddress);
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: JettonTransfer | "mint") {
